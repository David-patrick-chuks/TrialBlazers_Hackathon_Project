...
exports.registerOTP = (otp, lastName) => {
return `
    <!DOCTYPE html>
<html>
 <head>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; margin: 0 auto; background-color: transparent; font-family: Poppins, sans-serif;">
        ...
        <tr>
          <td style="height: 350px">
            ...
            <h2 style="font-size: 20px; margin: 0 0 10px;">Hi ${lastName},</h2>
            <p style="font-size: 17px; margin: 0 0 20px;">Here's your 6-digit code, enter it to verify your email and unlock the ErrandHive's fast delivery experience! One-Time-Password(OTP) expires in 5 minutes.</p>
